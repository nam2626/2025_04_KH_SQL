...
AS
SELECT C.ID, C.CNAME, CM.CM_NAME, C.PRICE, C.MYEAR
FROM CAR C INNER JOIN CAR_MAKER CM ON C.CM_ID = CM.CM_ID;

SELECT * FROM CAR_VIEW;

CREATE OR REPLACE VIEW CAR_MAKER_VIEW
AS
SELECT * FROM CAR_MAKER;

SELECT * FROM CAR_MAKER_VIEW;
SELECT * FROM CAR_MAKER WHERE CM_ID = 'AAAA';
INSERT INTO CAR_MAKER_VIEW VALUES('AAAA','TEST');
