...
-- 숫자 포멧
-- 9 : 숫자 한자리, 자리수가 없으면 공백으로 채움
-- 0 : 숫자 한자리, 자리수가 없으면 0으로 채움
SELECT TO_CHAR(1234.567,'999999.0000') FROM DUAL;
SELECT TO_CHAR(1234.567,'000000.0000') FROM DUAL;
-- 화폐 기호 - L : 지역설정 기준, $ : 달러
SELECT TO_CHAR(1234.567,'L999999.0000') FROM DUAL;
SELECT TO_CHAR(1234.567,'$999999.0000') FROM DUAL;
-- 천단위 기호
SELECT TO_CHAR(1234567,'$99,999,999') FROM DUAL;
SELECT TO_CHAR(1234567,'L99,999,999') FROM DUAL;

SELECT TO_CHAR(1234567.33,'$99G999G999D000') FROM DUAL;
SELECT TO_CHAR(1234567.33,'L99G999G999D000') FROM DUAL;
--FM : 불필요한 공백을 제거
SELECT TO_CHAR(1234567.33,'FM$99G999G999D000') FROM DUAL;
SELECT TO_CHAR(1234567.33,'FML99G999G999D000') FROM DUAL;
--
